...
class AirSimStrategy(Strategy.Strategy):
    ...
    def __init__(self, parent=None):
        ...
        self.UNIQUE_SAVE_LOCATION = r"F:\UAVProject\AirSim\PythonClient\EntropyRewrite\data-files\settings.json"  # CHANGE THIS TO WHERE EVER YOUR settings.json IS LOCATED
